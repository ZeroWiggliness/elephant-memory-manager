...
Example demonstrates new/delete using overloaded operations as mentioned in the documentation.
...
void main(void)
{
	...
	int *newmemtestarray = new(__FILE__) int[50];
	cFoo *pFoo = new cFoo;
	cFoo *pPlacement;
	cFoo *pFooArray = new cFoo[4];

	// THIS WILL WORK WITH OVERLOADS
